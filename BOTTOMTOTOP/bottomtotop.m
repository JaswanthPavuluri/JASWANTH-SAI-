...
% Reverse the order of the BPM data
bpm_data_reversed = flip(bpm_data);

% Number of clusters
k = 2; % Reduce the number of clusters

% Perform k-medoids clustering
[idx, medoids] = kmedoids(bpm_data_reversed', k); % Transpose the data

% Assign clusters
cluster1 = bpm_data_reversed(idx == 1);
cluster2 = bpm_data_reversed(idx == 2);
...
xlabel('Index');
ylabel('BPM');
title('K-medoids Clustering of BPM Data (Reversed)');
